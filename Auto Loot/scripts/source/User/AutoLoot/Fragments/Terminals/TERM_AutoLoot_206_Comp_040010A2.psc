...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_206_Comp_040010A2 Extends Terminal Hidden Const
...
; [ITXT]		8192 units
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Radius.GetAt(4) as GlobalVariable

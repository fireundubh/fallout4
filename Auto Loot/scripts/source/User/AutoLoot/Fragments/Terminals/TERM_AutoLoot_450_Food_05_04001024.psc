...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_450_Food_05_04001024 Extends Terminal Hidden Const
...
; [ITXT]		Dalton Farm
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Destination.GetAt(8) as GlobalVariable
kGlobal.SetValue(31)
;END CODE
EndFunction
;END FRAGMENT

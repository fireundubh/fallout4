...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_205_Bods_04001007 Extends Terminal Hidden Const
...
; [ITXT]		8192 units
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Radius.GetAt(3) as GlobalVariable

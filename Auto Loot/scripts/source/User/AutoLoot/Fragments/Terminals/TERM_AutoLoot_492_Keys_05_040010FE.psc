...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_492_Keys_05_040010FE Extends Terminal Hidden Const
...
; [ITXT]		Dalton Farm
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Destination.GetAt(11) as GlobalVariable
kGlobal.SetValue(31)
;END CODE
EndFunction
;END FRAGMENT

...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_424_Bods_03_0400103B Extends Terminal Hidden Const
...
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Destination.GetAt(3) as GlobalVariable
kGlobal.SetValue(18)
;END CODE
EndFunction
;END FRAGMENT

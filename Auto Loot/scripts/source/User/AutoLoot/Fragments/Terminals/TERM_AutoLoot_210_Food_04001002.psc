...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_210_Food_04001002 Extends Terminal Hidden Const
...
; [ITXT]		8192 units
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Radius.GetAt(8) as GlobalVariable

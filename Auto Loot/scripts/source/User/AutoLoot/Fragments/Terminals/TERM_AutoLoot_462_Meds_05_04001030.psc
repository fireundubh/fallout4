...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_462_Meds_05_04001030 Extends Terminal Hidden Const
...
; [ITXT]		Dalton Farm
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Destination.GetAt(13) as GlobalVariable
kGlobal.SetValue(31)
;END CODE
EndFunction
;END FRAGMENT

...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_207_Cont_04001008 Extends Terminal Hidden Const
...
; [ITXT]		8192 units
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Radius.GetAt(5) as GlobalVariable

...
ScriptName AutoLoot:Fragments:Terminals:TERM_AutoLoot_208_Drnk_04001001 Extends Terminal Hidden Const
...
; [ITXT]		8192 units
; ---------------------------------------------------------------------
GlobalVariable kGlobal = AutoLoot_Globals_Radius.GetAt(6) as GlobalVariable

ScriptName TrackEverything:dubhTrackEverythingHolotapeQuestScript Extends Quest
...
Event OnQuestShutdown()
	Player.AddItem(TrackEverythingHolotape, 1, False)
EndEvent
...
Form Property TrackEverythingHolotape Auto
